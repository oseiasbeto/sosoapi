...
const getPostsWithMediaByUserId = async (req, res) => {
    try {
        ...
        const posts = await Post.find({
            ...
            .skip(skip)
            .limit(limit)
            .populate('author', 'username name verified activity_status blocked_users gender posts_count subscribers following followers bio email website cover_photo profile_image')
