...
const user = new mongoose.Schema(
    {
        ...
        profile_image: {
            ...
            original: { type: String, default: 'https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png' }, // URL da imagem original
            low: { type: String, default: 'https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png' }, // Versão de baixa qualidade
            high: { type: String, default: 'https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png' }, // Versão de alta qualidade
            medium: { type: String, default: 'https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png' } // Versão média
        },
        ...
        privacy_settings: {
            profile_visibility: { type: String, enum: ["public", "friends_only", "private"], default: "public" },
            message_privacy: { type: String, enum: ["public", "friends_only", "private"], default: "friends_only" },
        },
