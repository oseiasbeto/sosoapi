...
const notificationSchema = new mongoose.Schema(
    {
        ...
        type: {
            ...
            enum: [
                ...
                "retweet",          // Compartilhamento de um post
                "message",          // Nova mensagem direta
        ...
        target_model: {
            type: String,
            enum: ["Post", "Message", "Relationship", "User", null],
            required: false,
        },
        message: {
            type: String,
            trim: true,
            maxlength: [280, "A mensagem da notificação não pode exceder 280 caracteres."],
...
notificationSchema.index({ recipient: 1, type: 1, target: 1 }, { unique: false }); // Para verificar duplicatas por tipo e alvo
